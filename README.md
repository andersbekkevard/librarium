In this directory we are porting the old bookkeep project to typescript, in order to more easily leverage modern libraries, and create a web app that can be used collaboratively with friends.
